...
QUERIES = {
    # Композиции, которые понравились заказчику на присланных референсах
    # (все пять были с водяными знаками Xiaohongshu, использовать нельзя).
    "angkor-through-frame": [
        "Angkor Wat window frame",
        "Angkor Wat doorway view",
        "Angkor Wat gallery columns",
        "Angkor Wat corridor palms",
    ],
    "bayon-wide": [
        "Bayon temple pond",
        "Bayon Angkor Thom panorama",
        "Bayon temple full view",
    ],
    "bayon-face-close": [
        "Bayon face tower",
        "Bayon smiling face closeup",
    ],
    "angkor-moat-palms": [
        "Angkor Wat moat sugar palm",
        "Angkor Wat reflection palm trees",
        "Angkor Wat west causeway",
    ],
}
