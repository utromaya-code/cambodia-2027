...
const galleryAlts: Record<string, string> = {
  ...
  'taprohm-doorway': 'Корни исполинского дерева стекают по стене Та-Прома над дверным проёмом',
  'taprohm-sky': 'Корни дерева на кровле храма Та-Пром на фоне синего неба',
  'sea-treehouse': 'Бирюзовое море, пальма и белый песок пляжа Ко Ронга',
  'jungle-river': 'Извилистая река в сплошной зелени тропического леса, вид сверху',
  ...
  'bayon-organizer-face': 'Один из каменных ликов храма Байон крупным планом',
};
