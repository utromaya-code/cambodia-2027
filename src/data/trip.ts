...
export const trip = {
  ...
  payment: {
    balanceDueBy: 'По приезде в Камбоджу',
  ...
  inclusions: {
    included: [
      ...
      'Общая программа: храмы, города, природа и вечера',
      'Сопровождение четырьмя ведущими',
      'Практики — йога, дыхание и цигун — по желанию',
    ],
    excluded: [
      'Обеды и ужины — едим вместе, платит каждый за себя',
...
export const hero = {
  kicker: 'Камбоджа',
  title: 'Дорога на юг',
  lead: 'Авторское путешествие от Ангкора до моря. Десять дней через деревни, джунгли, горы и побережье — на байке или в микроавтобусе.',
  dates: trip.dates.humanShort,
  note: 'Оставьте заявку — обсудим формат поездки и ответим на вопросы.',
...
export const intro = {
  ...
  lines: [
    'Один маршрут, одна компания и два способа ехать: на Honda FTR 230 или в микроавтобусе.',
    'За десять дней страна меняется под колёсами: камень Ангкора, красная земля, вода Тонлесапа, лес, горы, Кампот и море.',
  ],
} as const;
